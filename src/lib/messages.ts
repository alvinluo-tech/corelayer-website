...
const en = {
  ...
  home: {
    ...
    chips: ["Local-first", "Permission-guarded", "MCP connected"],
    subtitle:
      "A local-first AI control layer for your desktop apps, tools, models, and MCP workflows.",
    description:
    ...
    workflow: [
      ["User asks", "Through voice, keyboard shortcut, or chat input."],
      ["Jarvis interprets", "Parses intent, context, and conversation history."],
      ["Model Gateway routes", "Selects the right model for the task and budget."],
      [
    ...
    voiceTitle: "Voice that belongs to the desktop, not just the browser.",
    voiceBody:
